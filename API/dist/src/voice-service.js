...
export class VoiceService {
    constructor() {
        ...
        this.startTime = 0;
        this.CONVERSATION_DURATION = 60000; // 60 seconds
        ...
        if (this.apiKey && this.apiKey.length > 10) {
            console.log("ElevenLabs service initialized with API key:", this.apiKey.substring(0, 4) + "..." + this.apiKey.substring(this.apiKey.length - 4));
            this.useElevenLabs = true;
        }
        else {
